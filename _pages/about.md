...
* [Multimodal Intent Recognition Dataset](https://mintrec.github.io/)
...
* <strong>Hanlei Zhang</strong>, Hua Xu, Xin Wang, Fei Long, Kai Gao. USNID: A Framework for Unsupervised and Semi-supervised New Intent Discovery. <i>Under Review</i>. 2023. [[arXiv]](https://arxiv.org/abs/2304.07699)

## Publications

* <strong>Hanlei Zhang</strong>, Hua Xu, Shaojie Zhao, Qianrui Zhou. Learning Discriminative Representations and Decision Boundaries for Open Intent Detection.  <i>IEEE/ACM Transactions on Audio, Speech and Language Processing</i>. 2023. (<strong>IEEE/ACM TASLP, TH-CPL-A</strong>) [[paper]](https://ieeexplore.ieee.org/document/10097558) [[code]](https://github.com/thuiar/TEXTOIR) [[bibtex]](/files/TASLP23-DA-ADB/DA-ADB.bib)
