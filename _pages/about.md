...
* <strong>Hanlei Zhang</strong>, Hua Xu, Fei Long, Xin Wang, Kai Gao. Unsupervised Multimodal Clustering for Semantics Discovery in Multimodal Utterances. 2024. <i>Proceedings of the 62nd Annual Meeting of the Association for Computational Linguistics.</i> (<strong>ACL 2024 Main, CCF-A</strong>) [[paper]](https://arxiv.org/abs/2405.12775) [[code]](https://github.com/thuiar/UMC) [[bibtex]](/files/ACL24-UMC/UMC.bib)
* <strong>Hanlei Zhang</strong>\*, Xin Wang\*, Hua Xu, Qianrui Zhou, Kai Gao, Jianhua Su, Jinyue Zhao, Wenrui Li, Yanting Chen. MIntRec 2.0: A Large-scale Benchmark Dataset for Multimodal Intent Recognition and Out-of-scope Detection in Conversations. 2024. <i>Proceedings of the 12th International Conference on Learning Representations.</i> (<strong>ICLR 2024, TH-CPL-A</strong>) [[paper]](https://openreview.net/forum?id=nY9nITZQjc)  [[code]](https://github.com/thuiar/MIntRec2.0) [[bibtex]](/files/ICLR24-MIntRec2.0/MIntRec2.0.bib)
