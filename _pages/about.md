...
* <strong>Hanlei Zhang</strong>, Hua Xu, Fei Long, Xin Wang, Kai Gao. Unsupervised Multimodal Clustering for Semantics Discovery in Multimodal Utterances. 2024. <i>Proceedings of the 62nd Annual Meeting of the Association for Computational Linguistics.</i> (<strong>ACL 2024 Main Long Paper, CCF-A</strong>) [[paper]](Unsupervised Multimodal Clustering for Semantics Discovery in Multimodal Utterances) [[code]](https://github.com/thuiar/UMC)
